...
def teardown_module(module):
    print('teardown')
    channel = rabbitmq.create('amqp://guest:guest@localhost:5672/%2F')
...
def test_rabbitmq_send_message():
    ...
    rabbitmq_channel = rabbitmq.create('amqp://guest:guest@localhost:5672/%2F')
    ...
    rabbitmq.publish(rabbitmq_channel, 'testMessage', 'testQueue', 'testExchange')
